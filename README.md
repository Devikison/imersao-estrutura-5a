...
9. **A oferta** — título "Tudo o que a imersão entrega por R$ 27" sempre em duas linhas, em qualquer largura (`<br class="oferta-br">`, que ao contrário do `.hook-br` vale também no mobile). Card escuro com borda animada, logo da imersão (`.offer-logo`) no topo à esquerda, ao lado do selo "À venda hoje", preço R$ 27, checklist, botão e a nota "Pagamento seguro" abaixo dele.

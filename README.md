...
- **Seta dourada sobre o tricô (hero):** com as capas novas a pessoa ficou maior e mais à esquerda, e a seta neon inline (`top:85.2%;right:45%` no desktop, `top:57%;left:14%` no mobile) caiu em cima do suéter cru — antes ela ficava no fundo escuro e tinha contraste. Os selos do Google Ads e do Facebook continuam legíveis. Falta decidir para onde mover a seta, ou se ela sai.
